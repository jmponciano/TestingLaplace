...
PNsq1 <- ggplot(gridmcdf, aes(Beta.values, Rel.Prof.Like) ) + 
  ...
  geom_line(data = testUsq, aes( x=param, y=rel.like, linetype="red.line"), color = "red", linewidth=1) +
...
knitr::include_graphics("Usq-correct-01.png", dpi = 500)
...
Xpost.ModUsq <- Xpost.samp(model="Normsq.Pois", parm.list=parms.Usq,
...
PNsq.all <- ggplot(gridmcdf, aes(Beta.values, Rel.Prof.Like) ) + 
  ...
  geom_line(data = testUsq, aes( x=param, y=rel.like, linetype="red.line"), color = "black", linewidth=1) +
...
```
```{r echo=FALSE, fig.width=10, fig.height=8, fig.align='center'}
knitr::include_graphics("Usq-correct-02a.png", dpi = 500)
```
...
```{r echo=FALSE, fig.width=10, fig.height=8, fig.align='center'}
knitr::include_graphics("Usq-correct-02b.png", dpi = 500)
